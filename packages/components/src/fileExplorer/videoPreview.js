...
import { Backend } from "@globular/backend"; // still used for eventHub
...
import { getHiddenFiles, getImages } from "@globular/backend";
import { pathOf } from "./filevm-helpers";

import "@polymer/paper-ripple/paper-ripple.js";

export class VideoPreview extends HTMLElement {
  /** @type {import('@globular/backend').FileVM | any | null} */
  _file = null;
  /** @type {number} */
  _height = 0;
