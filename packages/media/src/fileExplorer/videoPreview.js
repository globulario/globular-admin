...
import { getHiddenFiles, getImages } from "@globular/sdk";
import { pathOf } from "@globular/components/fileExplorer/filevm-helpers.js";


export class VideoPreview extends HTMLElement {
  /** @type {import('@globular/sdk').FileVM | any | null} */
  _file = null;
  /** @type {number} */
  _height = 0;
