...
/**
 * Displays basic domain information.
 */
export class DomainInfo extends HTMLElement {
    // Private instance property to hold the domain data.
    _domain = null;

    /**
     * Constructor for the DomainInfo custom element.
    ...
    /**
     * Sets the domain data for the component.
     * This method will trigger the re-rendering of the domain's information
     * if the provided data is different from the current.
     * @param {Object} domain - The domain object containing display data (e.g., { name: "example.com" }).
     */
    set domain(domain) {
    ...
    /**
     * Gets the current domain data.
     * @returns {Object | null} The current domain object.
     */
    get domain() {
        return this._domain;
    }
     ...
     * the `domain` property is updated.
     * @private
     */
    _render() {
        // If no domain data, display a placeholder message.
        if (!this._domain) {
            ...
            <div id="container">
                ...
                <div class="info-table">
                    <div class="info-row">
                        ...
                        <div class="info-value">${this._domain.name}</div>
                    </div>
                </div>
            </div>
        `;
